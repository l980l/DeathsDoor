...
int MeshRenderUI::render_update()
{
    ...
    if (ImGui::BeginDragDropTarget())
    {
        ...
        if (pPayLoad)
        {
            ...
            if (RES_TYPE::MESH == pRes->GetType())
                GetTarget()->MeshRender()->SetMesh(static_cast<CMesh*>(pRes));
        }
    ...
    if (ImGui::Button("##MeshSelectBtn", ImVec2(18, 18)))
    {
        ...
        // �׸� ���ý� ȣ����� ��������Ʈ ���
        pListUI->AddDynamic_Select(this, static_cast<UI_DELEGATE_1>(&MeshRenderUI::SelectMesh));
    }
    ...
    if (ImGui::Button("##MtrlSelectBtn", ImVec2(18, 18)))
    {
        ...
        // �׸� ���ý� ȣ����� ��������Ʈ ���
        pListUI->AddDynamic_Select(this, static_cast<UI_DELEGATE_1>(&MeshRenderUI::SelectMaterial));
    }
    /*int datai0 = 0;
    int datai1 = 0;
    int datai2 = 0;
