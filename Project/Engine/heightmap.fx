...
void CS_HeightMap(int3 _iThreadID : SV_DispatchThreadID)
{
    ...
    // 해당 RayCast가 가리키는 위치 * Brush 범위에 있지 않다면 return
    ...
    HEIGHT_MAP[_iThreadID.xy] += g_DT * vBrushColor.a * VELOCITY; // 브러쉬 알파값으로 높이 설정
