...
#define                     MaxLevel                        g_int_2
#define                     TessFactorDist                  g_vec2_3
                ...
                , PatchOutput _patchtess)
{
    ...
    // 월드 방향 구하기
    // y값이 월드 스케일의 배율 적용을 받으므로 월드 기준 정점의 방향을 구해야 함.
